    ...
    <nav className="w-full h-20 bg-white">
      <div className="mx-40 px-4 sm:px-6 lg:px-8 h-full flex justify-between items-center">
        ...
        <div className="hidden md:flex justify-between gap-8 items-center">
          <div>
            <ul className="flex gap-6 font-montserrat text-sky-500 text-md">
          ...
          <div>
            <Button className="font-montserrat font-semibold cursor-pointer bg-sky-500 hover:bg-sky-800 transition-all duration-200 p-5">
              Get a Quote
            </Button>
          </div>
        </div>
