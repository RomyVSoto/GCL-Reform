...
export default function Services() {
  return (
    <div className="flex flex-col gap-48 my-30 mx-40">
      <secction className="flex flex-col gap-3 text-center">
        <h2 className="font-roboto font-semibold text-4xl">
      ...
      <secction className="flex mx-20 gap-20">
        <div className="flex flex-col gap-10 max-w-xl">
          <span className="flex flex-col gap-2">
            <h2 className="font-roboto font-semibold text-3xl">Our Story</h2>
          ...
          <span className="flex flex-col gap-2">
            <h2 className="font-roboto font-semibold text-3xl">Our Mission</h2>
            <p className="font-montserrat font-light text-lg">
          ...
          <span className="flex flex-col gap-2">
            <h2 className="font-roboto font-semibold text-3xl">Our Vision</h2>
            <p className="font-montserrat font-light text-lg">
      ...
      <secction className="flex flex-col gap-20 text-center">
        <h2 className="font-roboto font-semibold text-4xl">Meet Our Team</h2>
